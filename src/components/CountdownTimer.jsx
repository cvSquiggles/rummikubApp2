...
useEffect(() => {
    ...
    if(hours === 0 && minutes === 0 && seconds === 0 && milliseconds === 0 && playStarted){
    ...
    function startTimer () {
        ...
        if(hours !== 0 || minutes !== 0 || seconds !== 0 || milliseconds !== 0){
            ...
            window.alert("Player time is up!");
        }
    }
    ...
    return(
        ...
        {showEndScreen.show && <h2 className="title text-light">{showEndScreen.message}</h2>}
            ...
            minutes={minutes} hours={hours} changeSeconds={changeSeconds}
            changeMinutes={changeMinutes} changeHours={changeHours} />
